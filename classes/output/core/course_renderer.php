	        ...
	        if ($course->has_custom_fields()) {
              ...
              <div class="tilecontainer">
                  ...
                  if ($PAGE->theme->settings->coursetilestyle == 7) {
                      ...
                      $rowcontent .= '
                  <div class="col-md-12">
                      <div class="class-fullbox7" style="background-image: url(' . $imgurl . ');background-repeat: no-repeat;background-size:cover; background-position:center; background-color: rgba(0,0,0,0.3); background-blend-mode: overlay;">
                      <div class="fullbox7">
                          ';
